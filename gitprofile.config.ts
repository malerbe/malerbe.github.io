...
const CONFIG = {
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['malerbe/Encoders_Explained', 'malerbe/Decoders_Explained', 'malerbe/QRT_Challenge', 'malerbe/Dual-sPLS'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  resume: {
    fileUrl:
      'https://raw.githubusercontent.com/malerbe/malerbe.github.io/refs/heads/main/CV_2025.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
  'Python',
  'PHP',
